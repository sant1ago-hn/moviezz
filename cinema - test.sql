...
INSERT INTO `movies` (`id`, `title`, `IDcategory`, `lengthm`, `nation`, `yeary`, `views`, `stars`, `status`, `director`, `episode`, `movie_type`, `image`, `description`, `created_at`, `updated_at`, `trailer`, `link1080`, `en_sub`, `vie_sub`) VALUES
