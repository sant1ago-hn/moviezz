            ...
            <div class="col-12">
                <div class="header__content">
                    ...
                    <div class="header__actions">
                        ...
                        <a href="index.php?controller=user" class="header__user">
        ...
        <div class="row">
            ...
            <div class="col-12 col-xl-6">
                <div class="breadcrumb">
                    <?php if (isset($_SESSION['user'])): ?>
                        <a href="index.php?controller=user&action=logout" class="header__user">
                            <span>Sign out</span>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <div class="col-12">
                <div class="profile">
                    ...
                    <ul class="nav nav-tabs profile__tabs" id="profile__tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#tab-1" role="tab" aria-controls="tab-1" aria-selected="true">Profile</a>
                        </li>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                                                <div class="sign__group">
                                                    ...
                                                    <input id="username" type="text" name="username" class="sign__input" placeholder="<?php echo $_SESSION['user']['username'] ?>" readonly>
                                                </div>
                                            </div>
                                ...
                                <div class="col-12 col-lg-6">
                                    <form action="#" class="sign__form sign__form--profile">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <button class="sign__btn" type="submit" name="submit">Change</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
