...
<section class="section section--head section--head-fixed section--gradient section--details-bg">
    <div class="section__bg" data-bg="bg_img-details.jpg"></div>
    <div class="container">
        <!-- article -->
        <div class="article">
            <div class="row">
                <div class="col-12 col-xl-8">
                    <!-- trailer -->
                    <a href="<?php echo $movie['trailer']?>" class="article__trailer">
                ...
                <div class="col-12 col-xl-8">
                    ...
                    <div class="share">
                        ...
                        <a href="https://www.facebook.com/sharer/sharer.php?u=#" class="share__link share__link--fb" target="_blank">
                        ...
                        <a href="https://twitter.com/intent/tweet" class="share__link share__link--tw" target="_blank">
                                ...
                                <ul class="comments__list">
                                    <li class="comments__item">
                                        <div class="comments__autor">
                                            <img class="comments__avatar" src="frontend/assets/img/avatar.svg" alt="">
                                ...
                                <ul class="reviews__list">
                                    <li class="reviews__item">
                                        <div class="reviews__autor">
                                            <img class="reviews__avatar" src="frontend/assets/img/avatar.svg" alt="">
