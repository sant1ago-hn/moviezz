<!-- sign in -->
<div class="sign section--full-bg" data-bg="assets/img/bg.jpg" style="background: url('assets/img/bg.jpg') center center / cover no-repeat;">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="sign__content">
                    ...
                    <form action="" method="post" class="sign__form">
                        ...
                        <?php if (isset($_SESSION['error'])): ?>
                            <label class="sign__form">
                                <span class="form__message" style="color: red">
                                    <?php
                                    echo $_SESSION['error'];
                        ...
                        <span class="sign__text">Don't have an account? <a href="index.php?controller=login&action=register">Sign up!</a></span>
