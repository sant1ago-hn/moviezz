...
<main class="main">
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="dashbox">
                    ...
                    <div class="dashbox__table-wrap dashbox__table-wrap--2">
                        <table class="main__table main__table--dash">
                            ...
                            $sql = 'SELECT movies.*, categories.name AS category_name FROM movies INNER JOIN categories ON movies.idcategory = categories.id WHERE movies.status = 1 order BY created_at DESC limit 5';
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="main__table-text"><a href="#"><?php echo $result['title']?></a></div>
                                    </td>
                                    <td>
                                        <div class="main__table-text"><?php echo $result['category_name']?></div>
                                    </td>
                                    <td>
            ...
            <!-- end latest movies added dashbox -->
