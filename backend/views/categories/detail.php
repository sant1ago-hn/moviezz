        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="main__title">
                    <h2>Category detail ID: #<?php echo $category['id']?></h2>
                </div>
            </div>
            <!-- end main title -->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                                                <div class="sign__group">
                                                    ...
                                                    <input id="title" type="text" name="title" class="sign__input" placeholder="<?php echo $category['name'] ?>" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                                                <div class="sign__group">
                                                    <label class="sign__label" for="category">Status</label>
                                                    <input id="category" type="text" name="category" class="sign__input" placeholder="<?php if ($category['status'] == 1) echo 'Active'; else {echo 'Inactive';}  ?>" readonly>
                                                </div>
                                            </div>
