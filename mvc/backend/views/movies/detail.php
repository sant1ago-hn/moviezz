                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="sign__form sign__form--profile sign__form--first">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <a href="index.php?controller=movie&action=index" class="sign__btn" type="button">Back</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-6 col-lg-12">
                                                <div class="sign__group">
                                                    ...
                                                    <input id="oldpass" type="password" name="oldpass" class="sign__input" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
